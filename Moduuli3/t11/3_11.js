...
function x(title, caption, description, medium) {
  ...
  const figcaptiontext = document.createTextNode(caption);
...
for (let i = 0; i < picArray.length; i++) {
  x(picArray[i].title, picArray[i].caption, picArray[i].description,
      picArray[i].image.medium);
}
